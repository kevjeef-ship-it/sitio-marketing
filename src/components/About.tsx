  ...
  return (
    <section className="py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-4xl md:text-7xl font-display font-medium text-slate-900 leading-[1.1] mb-12">
          Un socio estratégico global dedicado a construir soluciones{" "}
          <span className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-brand-blue rounded-full text-white mx-1 align-middle">
            <svg className="w-6 h-6 md:w-8 md:h-8 fill-current" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" />
            </svg>
          </span>
          {" "}más inteligentes y{" "}
          <span className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-brand-lime rounded-full text-slate-900 mx-1 align-middle">
            <svg className="w-6 h-6 md:w-8 md:h-8 fill-current" viewBox="0 0 24 24">
